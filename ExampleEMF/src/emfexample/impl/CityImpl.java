 ...
 * <ul>
 *   <li>{@link emfexample.impl.CityImpl#getName <em>Name</em>}</li>
 *   <li>{@link emfexample.impl.CityImpl#getPeople <em>People</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CityImpl extends EObjectImpl implements City {
    ...
    protected EClass eStaticClass() {
        return EmfexamplePackage.Literals.CITY;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, EmfexamplePackage.CITY__NAME, oldName, name));
    }
    ...
    public EList<Person> getPeople() {
        if (people == null) {
            people = new EObjectWithInverseResolvingEList<Person>(Person.class, this, EmfexamplePackage.CITY__PEOPLE, EmfexamplePackage.PERSON__LIVES_IN);
        }
        return people;
    }
    ...
    public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
        switch (featureID) {
            case EmfexamplePackage.CITY__PEOPLE:
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case EmfexamplePackage.CITY__NAME:
                return getName();
            case EmfexamplePackage.CITY__PEOPLE:
                return getPeople();
        }
